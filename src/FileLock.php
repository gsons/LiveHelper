...
class FileLock extends Driver
{
    ...
    public function get($name, $default = false)
    {
        ...
        $content = $this->readFileData($filename);
        $this->expire = null;
        if (false !== $content) {
    ...
    public function set($name, $value, $expire = null)
    {
        ...
        $data = "<?php\n//" . sprintf('%012d', $expire) . "\n exit();?>\n" . $data;
        $result = $this->writeFileData($filename, $data);
    ...
    private function writeFileData($file, $data)
    {
        $fp = fopen($file, 'a');
